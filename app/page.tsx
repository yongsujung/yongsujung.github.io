...
const conferences = [
  ...
  ['2026', 'Lim, E., Kim, J., & Jung, Y.', 'Joint inverse calibration of wake surrogates and temporal wind-field corrections for wind-farm reliability assessment.', '대한기계학회 CAE 및 응용역학부문 2026년 춘계학술대회'],
  ['2026', 'Kim, S., Kim, J., & Jung, Y.', 'A framework for pack-level battery voltage prediction and model calibration using accelerated life testing data.', '대한기계학회 CAE 및 응용역학부문 2026년 춘계학술대회'],
  ['2026', 'Hwang, Y., Go, E., Yeon, D., Jung, Y., Kim, S., Kim, H.-U., & Kim, J.', 'Random forest and physics-based end point detection for reliable plasma etching under imbalanced experimental data.', '2026 대한기계학회 신뢰성부문 20주년 기념 학술대회'],
  ['2026', 'Kang, M., Go, E., Kim, S., Lee, J., Kang, W., Choi, M., Jung, Y., Kim, J., & Kim, H.-U.', 'DIC and machine learning-based etch depth prediction and uncertainty quantification in plasma etching.', '제70회 한국진공학회 동계정기학술대회'],
  ...
  ['2019', 'Jung, Y., Cho, H., & Lee, I.', 'Efficient reliability-based design optimization through enhanced initial point selection.', '대한기계학회 CAE 및 응용역학부문 2019년도 춘계학술대회'],
  ...
  ['2018', 'Jung, Y., Cho, H., & Lee, I.', 'Reliability analysis and optimization using efficient MPP-based dimension reduction.', '대한기계학회 CAE 및 응용역학부문 2018년도 춘계학술대회'],
  ...
  ['2017', 'Jung, Y., Lee, I., & Kang, N.', 'Modified AL-AD with parallelization in non-hierarchical analytical target cascading.', '대한기계학회 CAE 및 응용역학부문 2017년도 춘계학술대회'],
  ['2017', 'Jung, Y., Lee, I., & Kang, N.', 'Convergence strategy for parallel solving of analytical target cascading with augmented Lagrangian coordination.', '2017년도 한국전산역학회 학술대회'],
];
